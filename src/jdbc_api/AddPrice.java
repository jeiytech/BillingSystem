...
public class AddPrice extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String Price = p_name.getSelectedIndex() + 1 + "0" + b_name.getSelectedIndex() + 1 +"0"+ v_name.getSelectedIndex() + 1;
        double PRICE = Double.valueOf(price.getText());

        if(vName.isEmpty() || price.getText().isEmpty()){
            JOptionPane.showMessageDialog(this, "Form field cannot be empty...!", "Invalid", JOptionPane.INFORMATION_MESSAGE);
        }else{
            intoDatabase(Price, PRICE);
            clear();
        }
...
//    }
    ...
    private void intoDatabase(String Price, double PRICE) {
        Connection conn = javaConnect.connect();
        if(conn != null){
            try{
            PreparedStatement stmt = (PreparedStatement)
                    conn.prepareStatement("INSERT INTO ADDPRICE(PRID, PRICE) VALUES(?, ?)");
